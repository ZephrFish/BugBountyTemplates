...
- User Interaction Required: **Yes** (victim must view attacker's profile)
- CVSS 3.1 Score: **8.4** [(AV:N/AC:L/PR:L/UI:R/S:C/C:H/I:H/A:N)](https://www.first.org/cvss/calculator/3.1#CVSS:3.1/AV:N/AC:L/PR:L/UI:R/S:C/C:H/I:H/A:N)

### Severity Justification
- **Network Attack Vector**: Exploitable remotely over the internet
- **Low Complexity**: No special conditions required beyond normal app usage
- **Changed Scope**: XSS executes in victim's browser context, affecting resources beyond the vulnerable component
- **High Confidentiality/Integrity Impact**: Session hijacking, account takeover possible
...
1. Validate Content-Type header matches expected file types
2. Verify file magic bytes match the claimed file type
3. Store uploaded files with appropriate Content-Type and Content-Disposition headers
4. Implement Content Security Policy (CSP) headers
5. Sanitize filenames and restrict allowed extensions
...
- [1] [OWASP XSS Explained](https://owasp.org/www-community/attacks/xss/)
...
- [4] [CWE-79: Improper Neutralization of Input During Web Page Generation](https://cwe.mitre.org/data/definitions/79.html)
